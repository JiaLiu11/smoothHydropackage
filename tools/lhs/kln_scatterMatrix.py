...
sys.path.append('/Users/Jia/code/tools/pyhonPlotUtilities/')
import CSplottools
...
bNorm_bins= np.arange(bNorm_bd[0], bNorm_bd[1]+0.15, 0.15)

# load data
params_table = np.loadtxt('params_list_kln.dat')
...
# set color
linestyle, marker, color, shadowcolor = CSplottools.getPlotElements(1)
...
g.fig.savefig("taus_etas_kln.pdf", bbox_inches="tight")
g.fig.clear()
...
g.fig.savefig("taus_bulkNorm_kln.pdf", bbox_inches="tight")
g.fig.clear()
...
g.fig.savefig("etas_bulkNorm_kln.pdf", bbox_inches="tight")
